-- Deploy genomes_db:create_empty_lca_table_copies to pg
...
-- Note: swap-in of these tables to replace the live ones, and archiving of the current
--   tables, is deliberately out of scope here and will be a separate change.
